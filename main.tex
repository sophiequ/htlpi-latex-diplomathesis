...
\input{02--kooperationsvereinbarung}
\input{03--projektantrag}
\input{04--vorstudie}
\input{05--individueller-teil-schueler1}
% weitere individuelle Teile

\input{90--zusammenfassung-ausblick}
...
\listoftables
\input{acronyms}
\input{91--verfasserverzeichnis}
\input{92--begleitprotokolle}
